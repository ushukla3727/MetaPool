...
public class PlayFabManager : Photon.PunBehaviour, IChatClientListener
{
    ...
    IEnumerator Signup(String email)
    {
    ...
    public void OnSubscribed(string[] channels, bool[] results)
    {
        ...
        //GameManager.Instance.ClaimCoinDialog.GetComponent<ClaimCoinManager>().Show();
        //ccm.Show();
        //splashCanvas.SetActive (false);
    ...
    public override void OnJoinedRoom()
    {
        ...
        GameManager.Instance.ShowBannerAdd();
...
///////////////////////// Ads //////////////////////////
 ...
 private InterstitialAd interstitial;
    ...
    {
        GameManager.Instance.HideBannerAdd();
